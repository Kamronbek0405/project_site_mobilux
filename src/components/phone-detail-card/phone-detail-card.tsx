...
export const PhoneDetailCard: React.FC<phonesType> = ({ img, title, rame, color, brand, price, id }) => {
  ...
  return (
    <div className='flex items-center justify-center px-10  '>
      <div>
        ...
        <img src={img} alt={title} className='w-[480px] h-[480px] left  ' />
      </div>
      <div className='  px-40 relative'>
        <div className='absolute px-10 py-5 bg-black text-white flex flex-col right-[-68px] rounded-l-lg top-20 '>
